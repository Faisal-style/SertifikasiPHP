    ...
    <div class="bg-gambar">
        <div style="display: flex;">
            <div class="container-fluid container-fluids bgcont">
                <h3 style="text-align: center;">Perhitungan Lingkaran</h3>
                <form class="form-horizontal" action="lingkaran.php" method="POST">
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="angka1">Jari-jari :</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="alas" placeholder="Masukkan Jari Lingkaran" name="jari" />
                        </div>
                    </div>
                    <div class="form-group">
